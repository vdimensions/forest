...
namespace Forest.Engine.Aspects
{
    internal abstract class AbstractForestExecutionAspect : IForestExecutionAspect, IForestExecutionContext, IStateResolver
    {
        ...
        private readonly IForestExecutionAspect _aspect;
        ...
        public virtual void ExecuteCommand(IForestExecutionCutPoint cutPoint) => cutPoint.Proceed();
        public virtual void Navigate(IForestExecutionCutPoint cutPoint) => cutPoint.Proceed();
